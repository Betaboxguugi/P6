...
\newcommand{\insertcodefile}[2]{\lstinputlisting[caption=#2,label=#1,style=Python1,float=h]{codeRelated/scripts/#1}} % The first argument is the script location/filename and the second is a caption for the code
