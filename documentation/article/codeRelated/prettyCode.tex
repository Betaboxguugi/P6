...
\definecolor{color3}{RGB}{230, 231, 231} 
...
\begin{lstlisting}[caption=#2,style=Python1]
	#1
\end{lstlisting}
} 

\newcommand{\insertcodefile}[2]{\lstinputlisting[caption=#2,label=#1,style=Python1]{#1}} % The first argument is the script location/filename and the second is a caption for the code
