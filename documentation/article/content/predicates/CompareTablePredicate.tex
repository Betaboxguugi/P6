...
>>>>>>> 587219b2b78d1a654bff31ee55e7dc11a2c352f6
\end{description}
...
<<<<<<< HEAD
\insertcodefileSQL{SQLCompareTableDW2.sql}{SQL query if expected table in DW and we account for duplicates in the case of \cref{CompareTablePredicate.py}} 
=======
