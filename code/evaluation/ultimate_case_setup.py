...
ctp_test = CompareTablePredicate(table1, table2)
...
pred_list = [cnnp_test, fdp_test, ndrp_test, rocp_test, rucp_test,
             rrp_test, scdvp_test]# mangler(ikke færdig) --> ctp_test
